# PostgreSQL (PostGIS) service for Wodby

Use PostgreSQL (PostGIS) as a reusable component in applications managed by
Wodby. This repository contains the service manifests and referenced files used
by the public PostgreSQL (PostGIS) service in the Wodby catalog.

- [PostgreSQL (PostGIS) service in the Wodby catalog](https://wodby.com/services/postgis)
...
4. Reference `postgis` from your stack manifest.
